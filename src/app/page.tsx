    ...
    <div className="flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
      ...
      <a href="" className="flex items-center gap-3 text-left">
        ...
        <p className='text-sm leading-snug max-w[140px]'>
          <span className='underline  hover:text-gray-50 transition-colors'>Crie sua conta</span> e salve suas memórias!</p>
      </a>
      ...
      <div className="space-y-5">
        ...
        <div className="max-w-[420px] space-y-1">
          <h1 className="text-5xl font-bold leading-tight text-grey-50">Sua cápsula do tempo</h1>
      ...
      {/* Copyright */}
      <div className="text-sm leading-relaxed text-grey-200">
